...
print(dir_path)
chrome_major_version = get_major_version(get_chrome_version())
print(chrome_major_version)
final_chromedriver_path = f'{dir_path}/chromedriver'
